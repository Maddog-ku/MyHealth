...
function Metric({
  ...
  return (
    <Card className={`border border-slate-100/80 dark:border-slate-900/40 border-l-4 ${colorMap[color]} bg-white/60 dark:bg-slate-950/20 backdrop-blur-xl shadow-md shadow-slate-100/50 dark:shadow-none rounded-2xl overflow-hidden card-hover-effect`}>
